...
public abstract class Ordenari {
    ...
    static Object[][] busquedaHoras(String hora1,String hora2,Object[][] arreglo){
        Parser par = new Parser();
        int numeroHoras=Integer.parseInt(hora1)-Integer.parseInt(hora2);
        int ihora1=Integer.parseInt(hora1);
        int ihora2 = Integer.parseInt(hora2);
        Object[][] resultado= new Object[100][5];
        int indice=0;
        for(int i=0;i<arreglo.length;i++){
            if(Integer.parseInt(Ordenari.getHora(arreglo[i][4].toString()))>ihora1&&ihora2>Integer.parseInt(Ordenari.getHora(arreglo[i][4].toString()))){
        ...
        int contador=0;
        for(int r=0;r<arreglo.length&&arreglo[r]!=null;r++){
            contador++;
    ...
    static Object[][] busquedaDias(String dia1,String dia2,Object[][] arreglo){
        int numeroDias=Integer.parseInt(dia1)-Integer.parseInt(dia2);
        int idia1=Integer.parseInt(dia1);
        int idia2 = Integer.parseInt(dia2);
        Object[][] resultado= new Object[100][5];
        int indice=0;
        for(int i=0;i<arreglo.length;i++){
            if(Integer.parseInt(Ordenari.getDia(arreglo[i][4].toString()))>idia1&&idia2>Integer.parseInt(Ordenari.getDia(arreglo[i][4].toString()))){
                resultado[indice]=arreglo[i];
                indice++;
            }
    ...
    static Object[][] busquedaMes(String mes1,String mes2,Object[][] arreglo){
        int numeroDias=Integer.parseInt(mes1)-Integer.parseInt(mes2);
        int idia1=Integer.parseInt(mes1);
        int idia2 = Integer.parseInt(mes2);
        Object[][] resultado= new Object[100][5];
        int indice=0;
        for(int i=0;i<arreglo.length;i++){
            if(Integer.parseInt(Ordenari.getMes(arreglo[i][4].toString()))>idia1&&idia2>Integer.parseInt(Ordenari.getMes(arreglo[i][4].toString()))){
                resultado[indice]=arreglo[i];
                indice++;
            }
    ...
    static Object[][] tipo(Object[][] arreglo){
        ...
        int indice=0;
            for(int j=0;j<arreglo.length;j++){
                ...
                for(int u=0;u<arreglo.length;u++){
                    if(arreglo[u][2].equals("Persona con discapacidad")&&contador==0){
                        temp=arreglo[indice];
 ...
 */
  public static Object[][] Alfabeticamente(Object [][] arreglo){
        ...
        public static void main(String[] args) throws IOException{
            ...
            System.out.println("Estas son las fechas"+Ordenari.busquedaHoras("3", "19", t)[10][4]);
            System.out.println("Estas son las fechas"+Ordenari.busquedaDias("14", "19", t)[0][4]);
            System.out.println("Estas son las fechas"+Ordenari.busquedaMes("0", "19", t)[0][4]);
